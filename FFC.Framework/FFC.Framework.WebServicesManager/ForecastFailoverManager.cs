...
namespace FFC.Framework.WebServicesManager
{
    public class ForecastFailoverManager
    {
        ...
        public string ForecastFailoverAlgorithm(List<BranchItemData> branchItemDataList)
        {
            ...
            Message = Message + String.Format("</br> NET Previous Surplus wastage Cost: {0}", previousWastageCost.ToString());
            Message = Message + String.Format("</br> NET Alogrithm Transport Cost: {0}", costForTransport.ToString());
            Message = Message + String.Format("</br> NET Algorithm Gain/Cost: {0}", algorithmTotalGain.ToString());
            Message = Message + String.Format("</br> NET Algorithm Effective Gain: {0}</b>", algorithmEffectiveGain.ToString());
